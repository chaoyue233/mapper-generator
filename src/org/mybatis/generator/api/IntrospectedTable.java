...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
      ...
      //@Nothing-add  
        ...
        ATTR_SELECT_BY_CDT_LIKE_STATEMENT_ID
    }
    
    public String getSelectByCdtStatementId() {
//    	this.getSelectByPrimaryKeyQueryId()
    ...
    public String getSelectByCdtLikeStatementId() {
//    	this.getSelectByPrimaryKeyQueryId()
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_CDT_LIKE_STATEMENT_ID);
    }
    public void setSelectByCdtLikeStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_CDT_LIKE_STATEMENT_ID, s);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByCdtStatementId("selectByModel");
        setSelectByCdtLikeStatementId("selectByModelLike");
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Mapper");//sb.append("Mapper"); //$NON-NLS-1$
