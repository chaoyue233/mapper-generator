...
public class SelectByCdtLikeElementGenerator extends AbstractXmlElementGenerator {

	public SelectByCdtLikeElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute("id", introspectedTable.getSelectByCdtLikeStatementId())); //$NON-NLS-1$  
		...
		for (IntrospectedColumn introspectedColumn : list) {
			...
			Object type = introspectedColumn.getFullyQualifiedJavaType();//java.lang.String
			if(type != null && "java.lang.String".equals(type.toString()) ){//string类型
				sb.setLength(0);
				sb.append("and ");
				sb.append(MyBatis3FormattingUtilities.getAliasedEscapedColumnName(introspectedColumn));
				sb.append(" like CONCAT('%',"); //like CONCAT('%',#{ownerName},'%')
