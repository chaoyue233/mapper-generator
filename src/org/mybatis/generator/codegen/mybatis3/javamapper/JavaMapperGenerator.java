...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByCdtLikeMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
      ...
      //@Nothing-Add  
        ...
        addSelectByCdtLikeMethod(interfaze);
  ...
  //@Nothing-Add  
    ...
    protected void addSelectByCdtLikeMethod(Interface interfaze) {  
        //这里我就直接和主键生成绑定吧！懒的写了！  
        if (introspectedTable.getRules().generateSelectByPrimaryKey()) {  
            AbstractJavaMapperMethodGenerator methodGenerator = new SelectByCdtLikeMethodGenerator(false);  
            initializeAndExecuteGenerator(methodGenerator, interfaze);  
        }  
    } 
